...
function projectdirectories(basepath::String, silent::Bool=false)::Dict{String,String}
    prjdirs = Dict{String,String}(
        ...
        "agp" => joinpath(basepath, "ocswitrs"),
        "agpaprx" => joinpath(basepath, "ocswitrs", "ocswitrs.aprx"),
        "agpgdb" => joinpath(basepath, "ocswitrs", "ocswitrs.gdb"),
        "agpgdbraw" => joinpath(basepath, "ocswitrs", "ocswitrs.gdb", "raw"),
        "agpgdbsupporting" => joinpath(basepath, "ocswitrs", "ocswitrs.gdb", "supporting"),
        "agpgdbanalysis" => joinpath(basepath, "ocswitrs", "ocswitrs.gdb", "analysis"),
        "agpgdbhotspots" => joinpath(basepath, "ocswitrs", "ocswitrs.gdb", "hotspots"),
