...
octr = OCTraffic(part = 8, version = 2025.4)
...
# Define map layers
map_collisions_lyr_boundaries = map_collisions.listLayers("OCTraffic Boundaries")[0]
map_collisions_lyr_cities = map_collisions.listLayers("OCTraffic Cities")[0]
map_collisions_lyr_blocks = map_collisions.listLayers("OCTraffic Census Blocks")[0]
map_collisions_lyr_roads = map_collisions.listLayers("OCTraffic Roads")[0]
map_collisions_lyr_collisions = map_collisions.listLayers("OCTraffic Collisions")[0]
...
# Define map layers
map_crashes_lyr_boundaries = map_crashes.listLayers("OCTraffic Boundaries")[0]
map_crashes_lyr_cities = map_crashes.listLayers("OCTraffic Cities")[0]
map_crashes_lyr_blocks = map_crashes.listLayers("OCTraffic Census Blocks")[0]
map_crashes_lyr_roads = map_crashes.listLayers("OCTraffic Roads")[0]
map_crashes_lyr_crashes = map_crashes.listLayers("OCTraffic Crashes")[0]
...
# Define map layers
map_parties_lyr_boundaries = map_parties.listLayers("OCTraffic Boundaries")[0]
map_parties_lyr_cities = map_parties.listLayers("OCTraffic Cities")[0]
map_parties_lyr_blocks = map_parties.listLayers("OCTraffic Census Blocks")[0]
map_parties_lyr_roads = map_parties.listLayers("OCTraffic Roads")[0]
map_parties_lyr_parties = map_parties.listLayers("OCTraffic Parties")[0]
...
# Define map layers
map_victims_lyr_boundaries = map_victims.listLayers("OCTraffic Boundaries")[0]
map_victims_lyr_cities = map_victims.listLayers("OCTraffic Cities")[0]
map_victims_lyr_blocks = map_victims.listLayers("OCTraffic Census Blocks")[0]
map_victims_lyr_roads = map_victims.listLayers("OCTraffic Roads")[0]
map_victims_lyr_victims = map_victims.listLayers("OCTraffic Victims")[0]
...
# Define map layers
map_injuries_lyr_boundaries = map_injuries.listLayers("OCTraffic Boundaries")[0]
map_injuries_lyr_cities = map_injuries.listLayers("OCTraffic Cities")[0]
map_injuries_lyr_blocks = map_injuries.listLayers("OCTraffic Census Blocks")[0]
map_injuries_lyr_victims = map_injuries.listLayers("OCTraffic Victims")[0]
...
# Define map layers
map_fatalities_lyr_boundaries = map_fatalities.listLayers("OCTraffic Boundaries")[0]
map_fatalities_lyr_roads = map_fatalities.listLayers("OCTraffic Roads")[0]
map_fatalities_lyr_roads_major_buffers = map_fatalities.listLayers(
    "OCTraffic Major Roads Buffers"
)[0]
map_fatalities_lyr_fatalities = map_fatalities.listLayers("OCTraffic Crashes")[0]
...
# Define map layers
map_fhs_100m1km_lyr_boundaries = map_fhs_100m1km.listLayers("OCTraffic Boundaries")[0]
map_fhs_100m1km_lyr_cities = map_fhs_100m1km.listLayers("OCTraffic Cities")[0]
map_fhs_100m1km_lyr_blocks = map_fhs_100m1km.listLayers("OCTraffic Census Blocks")[0]
map_fhs_100m1km_lyr_roads = map_fhs_100m1km.listLayers("OCTraffic Roads")[0]
map_fhs_100m1km_lyr_fhs_100m1km = map_fhs_100m1km.listLayers(
    "OCTraffic Crashes Find Hot Spots 100m 1km"
)[0]
...
# Define map layers
map_fhs_150m2km_lyr_boundaries = map_fhs_150m2km.listLayers("OCTraffic Boundaries")[0]
map_fhs_150m2km_lyr_cities = map_fhs_150m2km.listLayers("OCTraffic Cities")[0]
map_fhs_150m2km_lyr_blocks = map_fhs_150m2km.listLayers("OCTraffic Census Blocks")[0]
map_fhs_150m2km_lyr_roads = map_fhs_150m2km.listLayers("OCTraffic Roads")[0]
map_fhs_150m2km_lyr_fhs_150m2km = map_fhs_150m2km.listLayers(
    "OCTraffic Crashes Find Hot Spots 150m 2km"
)[0]
...
# Define map layers
map_fhs_100m5km_lyr_boundaries = map_fhs_100m5km.listLayers("OCTraffic Boundaries")[0]
map_fhs_100m5km_lyr_cities = map_fhs_100m5km.listLayers("OCTraffic Cities")[0]
map_fhs_100m5km_lyr_blocks = map_fhs_100m5km.listLayers("OCTraffic Census Blocks")[0]
map_fhs_100m5km_lyr_roads = map_fhs_100m5km.listLayers("OCTraffic Roads")[0]
map_fhs_100m5km_lyr_fhs_100m5km = map_fhs_100m5km.listLayers(
    "OCTraffic Crashes Find Hot Spots 100m 5km"
)[0]
...
# Define map layers
map_fhs_roads_500ft_lyr_boundaries = map_fhs_roads_500ft.listLayers("OCTraffic Boundaries")[0]
map_fhs_roads_500ft_lyr_cities = map_fhs_roads_500ft.listLayers("OCTraffic Cities")[0]
map_fhs_roads_500ft_lyr_blocks = map_fhs_roads_500ft.listLayers("OCTraffic Census Blocks")[0]
map_fhs_roads_500ft_lyr_roads = map_fhs_roads_500ft.listLayers("OCTraffic Roads")[0]
...
# Define map layers
map_ohs_roads_500ft_lyr_boundaries = map_ohs_roads_500ft.listLayers("OCTraffic Boundaries")[0]
map_ohs_roads_500ft_lyr_cities = map_ohs_roads_500ft.listLayers("OCTraffic Cities")[0]
map_ohs_roads_500ft_lyr_blocks = map_ohs_roads_500ft.listLayers("OCTraffic Census Blocks")[0]
map_ohs_roads_500ft_lyr_roads = map_ohs_roads_500ft.listLayers("OCTraffic Roads")[0]
...
# Define map layers
map_road_crashes_lyr_boundaries = map_road_crashes.listLayers("OCTraffic Boundaries")[0]
map_road_crashes_lyr_blocks = map_road_crashes.listLayers("OCTraffic Census Blocks")[0]
map_road_crashes_lyr_roads_major = map_road_crashes.listLayers("OCTraffic Major Roads")[0]
map_road_crashes_lyr_crashes_500ft_roads = map_road_crashes.listLayers(
    "OCTraffic Crashes 500 Feet from Major Roads"
)[0]
...
# Define map layers
map_road_hotspots_lyr_boundaries = map_road_hotspots.listLayers("OCTraffic Boundaries")[0]
map_road_hotspots_lyr_blocks = map_road_hotspots.listLayers("OCTraffic Census Blocks")[0]
map_road_hotspots_lyr_roads_major = map_road_hotspots.listLayers("OCTraffic Major Roads")[0]
...
# Define map layers
map_road_buffers_lyr_boundaries = map_road_buffers.listLayers("OCTraffic Boundaries")[0]
map_road_buffers_lyr_blocks = map_road_buffers.listLayers("OCTraffic Census Blocks")[0]
map_road_buffers_lyr_roads_major = map_road_buffers.listLayers("OCTraffic Major Roads")[0]
map_road_buffers_lyr_road_buffers = map_road_buffers.listLayers("OCTraffic Major Roads Buffers Summary")[0]
...
# Define map layers
map_road_segments_lyr_boundaries = map_road_segments.listLayers("OCTraffic Boundaries")[0]
map_road_segments_lyr_blocks = map_road_segments.listLayers("OCTraffic Census Blocks")[0]
map_road_segments_lyr_roads_major = map_road_segments.listLayers("OCTraffic Major Roads")[0]
map_road_segments_lyr_roads_major_split = map_road_segments.listLayers(
    "OCTraffic Major Roads Split Buffer Summary"
)[0]
...
# Define map layers
map_roads_lyr_roads_major = map_roads.listLayers("OCTraffic Major Roads")[0]
map_roads_lyr_roads_major_buffers = map_roads.listLayers("OCTraffic Major Roads Buffers")[0]
map_roads_lyr_roads_major_buffers_sum = map_roads.listLayers(
    "OCTraffic Major Roads Buffers Summary"
)[0]
map_roads_lyr_roads_major_points_along_lines = map_roads.listLayers(
    "OCTraffic Major Roads Points Along Lines"
)[0]
map_roads_lyr_roads_major_split = map_roads.listLayers("OCTraffic Major Roads Split")[0]
map_roads_lyr_roads_major_split_buffer = map_roads.listLayers(
    "OCTraffic Major Roads Split Buffer"
)[0]
...
# Define map layers
map_point_fhs_lyr_boundaries = map_point_fhs.listLayers("OCTraffic Boundaries")[0]
map_point_fhs_lyr_roads_major = map_point_fhs.listLayers("OCTraffic Major Roads")[0]
map_point_fhs_lyr_fhs = map_point_fhs.listLayers("OCTraffic Crashes Hot Spots")[0]
...
# Define map layers
map_point_ohs_lyr_boundaries = map_point_ohs.listLayers("OCTraffic Boundaries")[0]
map_point_ohs_lyr_roads_major = map_point_ohs.listLayers("OCTraffic Major Roads")[0]
map_point_ohs_lyr_ohs = map_point_ohs.listLayers("OCTraffic Crashes Optimized Hot Spots")[0]
...
# Define map layers
map_pop_dens_lyr_boundaries = map_pop_dens.listLayers("OCTraffic Boundaries")[0]
map_pop_dens_lyr_roads_major = map_pop_dens.listLayers("OCTraffic Major Roads")[0]
map_pop_dens_lyr_pop_dens = map_pop_dens.listLayers("OCTraffic Population Density")[0]
...
# Define map layers
map_hou_dens_lyr_boundaries = map_hou_dens.listLayers("OCTraffic Boundaries")[0]
map_hou_dens_lyr_roads_major = map_hou_dens.listLayers("OCTraffic Major Roads")[0]
map_hou_dens_lyr_hou_dens = map_hou_dens.listLayers("OCTraffic Housing Density")[0]
...
# Define map layers
map_area_cities_lyr_boundaries = map_area_cities.listLayers("OCTraffic Boundaries")[0]
map_area_cities_lyr_roads_major = map_area_cities.listLayers("OCTraffic Major Roads")[0]
map_area_cities_lyr_cities = map_area_cities.listLayers("OCTraffic Cities Summary")[0]
...
# Define map layers
map_area_blocks_lyr_boundaries = map_area_blocks.listLayers("OCTraffic Boundaries")[0]
map_area_blocks_lyr_roads_major = map_area_blocks.listLayers("OCTraffic Major Roads")[0]
map_area_blocks_lyr_blocks = map_area_blocks.listLayers("OCTraffic Census Blocks Summary")[0]
...
# Define map layers
map_summaries_lyr_blocksSum = map_summaries.listLayers("OCTraffic Census Blocks Summary")[0]
map_summaries_lyr_citiesSum = map_summaries.listLayers("OCTraffic Cities Summary")[0]
...
# Define map layers
map_analysis_lyr_crashes_hotspots = map_analysis.listLayers("OCTraffic Crashes Hot Spots")[0]
map_analysis_lyr_crashes_optimized_hotspots = map_analysis.listLayers(
    "OCTraffic Crashes Optimized Hot Spots"
)[0]
...
# Define map layers
map_regression_lyr_boundaries = map_regression.listLayers("OCTraffic Boundaries")[0]
map_regression_lyr_cities = map_regression.listLayers("OCTraffic Cities")[0]
map_regression_lyr_blocks = map_regression.listLayers("OCTraffic Census Blocks")[0]
map_regression_lyr_roads = map_regression.listLayers("OCTraffic Roads")[0]
...
mdo_maps_layout.title = "OCTraffic Maps Layout"
mdo_maps_layout.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCTraffic, Transportation"
mdo_maps_layout.summary = "Layout for the OCTraffic Project Maps"
mdo_maps_layout.description = """<div style = "text-align:Left;"><div><div><p><span>Layout for the OCTraffic Project Maps</span></p></div></div></div>"""
...
mdo_injuries_layout.title = "OCTraffic Injuries Layout"
mdo_injuries_layout.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCTraffic, Transportation"
mdo_injuries_layout.summary = "Layout for the OCTraffic Project Injuries"
mdo_injuries_layout.description = """<div style = "text-align:Left;"><div><div><p><span>Layout for the OCTraffic Project Injuries</span></p></div></div></div>"""
...
mdo_hotspots_layout.title = "OCTraffic Hot Spots Layout"
mdo_hotspots_layout.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCTraffic, Transportation"
mdo_hotspots_layout.summary = "Layout for the OCTraffic Project Hot Spots"
mdo_hotspots_layout.description = """<div style = "text-align:Left;"><div><div><p><span>Layout for the OCTraffic Project Hot Spots</span></p></div></div></div>"""
...
mdo_roads_layout.title = "OCTraffic Road Hot Spots Layout"
mdo_roads_layout.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCTraffic, Transportation"
mdo_roads_layout.summary = "Layout for the OCTraffic Project Roads Hot Spots"
mdo_roads_layout.description = """<div style = "text-align:Left;"><div><div><p><span>Layout for the OCTraffic Project Hot Spots</span></p></div></div></div>"""
...
mdo_points_layout.title = "OCTraffic Optimized Hot Spots Layout"
mdo_points_layout.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCTraffic, Transportation"
mdo_points_layout.summary = "Layout for the OCTraffic Project Optimized Hot Spots"
mdo_points_layout.description = """<div style = "text-align:Left;"><div><div><p><span>Layout for the OCTraffic Project Optimized Hot Spots</span></p></div></div></div>"""
...
mdo_densities_layout.title = "OCTraffic Densities Layout"
mdo_densities_layout.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCTraffic, Transportation"
mdo_densities_layout.summary = "Layout for the OCTraffic Project Densities"
mdo_densities_layout.description = """<div style = "text-align:Left;"><div><div><p><span>Layout for the OCTraffic Project Densities</span></p></div></div></div>"""
...
mdo_areas_layout.title = "OCTraffic Areas Layout"
mdo_areas_layout.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCTraffic, Transportation"
mdo_areas_layout.summary = "Layout for the OCTraffic Project Areas"
mdo_areas_layout.description = """<div style = "text-align:Left;"><div><div><p><span>Layout for the OCTraffic Project Areas</span></p></div></div></div>"""
...
for mf in maps_layout.listElements("MAPFRAME_ELEMENT"):
    for l in mf.map.listLayers():
        if l.name in [
            "OCTraffic Collisions",
            "OCTraffic Crashes",
            "OCTraffic Parties",
            "OCTraffic Victims",
            "OCTraffic Roads",
            "OCTraffic Cities",
            "OCTraffic Boundaries",
            "Light Gray Base",
        ]:
            l.visible = True
        else:
...
for i in maps_lg1_cim.items:
    if i.name == "OCTraffic Collisions":
        i.isVisible = True
...
for i in maps_lg3_cim.items:
    if i.name == "OCTraffic Cities":
        ...
        i.headingSymbol.symbol.height = 16
        i.labelSymbol.symbol.height = 14
    elif i.name == "OCTraffic Boundaries":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
graphics_list = octr.graphics_entry(
    ...
    gr_attr = {
        ...
        "name": "OCTraffic Collisions Maps Layout",
        "description": "Map layout for the OCTraffic project, visualizing collisions, crashes, parties, and victims data.",
        "caption": f"Visual mapping of the OCTraffic collision data between {date_start.year} and {date_end.year}. The top left subgraph (a) displays all the collision data in the dataset. The remaining subgraphs (b), (c) and (d) display the crashes, parties, and victims sub-datasets. The visual display of points is color-coded by the collision severity classification.",
        "type": "GIS Layout",
...
for i in injuries_lg2_cim.items:
    if i.name == "OCTraffic Crashes":
        ...
        i.headingSymbol.symbol.height = 16
        i.labelSymbol.symbol.height = 14
    elif i.name == "OCTraffic Major Roads Buffers":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
graphics_list = octr.graphics_entry(
    ...
    gr_attr = {
        ...
        "name": "OCTraffic Injuries Layout",
        "description": "Map layout for the OCTraffic project, visualizing victim injuries and fatalities data.",
        "caption": f"Visual mapping of the OCTraffic collision data between {date_start.year} and {date_end.year}. The left subgraph displays all the victim injuries reported during the time period, color-coded by the level of severity (fatal, severe, minor, or pain). The right subgraph shows only collision incidents involving victims killed as a result of the crash (from single to multiple fatalities).",
        "type": "GIS Layout",
        "method": "geoprocessing",
        "file_format": ".png",
...
for mf in hotspots_layout.listElements("MAPFRAME_ELEMENT"):
    for l in mf.map.listLayers():
        if l.name in [
            ...
            "OCTraffic Boundaries",
            "OCTraffic Roads",
            "OCTraffic Census Blocks",
            "Light Gray Base",
        ]:
            l.visible = True
            if l.name in ["OCTraffic Census Blocks", "OCTraffic Roads"]:
                l.transparency = 65
        else:
            l.visible = False
...
for i in hotspots_lg1_cim.items:
    if i.name == "OCTraffic Crashes Find Hot Spots 100m 1km":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
for i in hotspots_lg3_cim.items:
    if i.name == "OCTraffic Census Blocks":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
graphics_list = octr.graphics_entry(
    ...
    gr_attr = {
        ...
        "name": "OCTraffic Hotspots Layout",
        "description": "Map layout for the OCTraffic project, visualizing crash hotspots data.",
...
for i in roads_lg1_cim.items:
    if i.name == "OCTraffic Crashes 500 Feet from Major Roads":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
for i in roads_lg2_cim.items:
    if i.name == "OCTraffic Crashes Hot Spots 500 Feet from Major Roads":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
for i in roads_lg3_cim.items:
    if i.name == "OCTraffic Major Roads Buffers Summary":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
for i in roads_lg4_cim.items:
    if i.name == "OCTraffic Major Roads Split Buffer Summary":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
# Add title for the OCTraffic Crashes Hot Spots 500 Feet from Major Roads map frame (title 2) tpo the layout
# Check if the fhs_roads_500ft title already exist and if it is, delete it
...
# Add title for the OCTraffic Major Roads Buffers Summary map frame (title 3) to the layout
# Check if the fhs_roads_500ft title already exist and if it is, delete it
...
# Add title for the OCTraffic Major Roads Split Buffer Summary map frame (title 4) to the layout
# Check if the fhs_roads_500ft title already exist and if it is, delete it
...
graphics_list = octr.graphics_entry(
    ...
    gr_attr = {
        ...
        "name": "OCTraffic Roads Layout",
        "description": "Map layout for the OCTraffic project, visualizing road hotspots data.",
...
for i in points_lg1_cim.items:
    if i.name == "OCTraffic Crashes Hot Spots":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
for i in points_lg2_cim.items:
    if i.name == "OCTraffic Crashes Optimized Hot Spots":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
graphics_list = octr.graphics_entry(
    ...
    gr_attr = {
        ...
        "name": "OCTraffic Points Layout",
        "description": "Map layout for the OCTraffic project, visualizing points hotspots data.",
...
for mf in densities_layout.listElements("MAPFRAME_ELEMENT"):
    for l in mf.map.listLayers():
        if l.name in [
            "OCTraffic Population Density",
            "OCTraffic Housing Density",
            "OCTraffic Boundaries",
            "Light Gray Base",
        ]:
            l.visible = True
...
for i in densities_lg1_cim.items:
    if i.name == "OCTraffic Population Density":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
for i in densities_lg2_cim.items:
    if i.name == "OCTraffic Housing Density":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
graphics_list = octr.graphics_entry(
    ...
    gr_attr = {
        ...
        "name": "OCTraffic Densities Layout",
        "description": "Map layout for the OCTraffic project, visualizing densities data.",
...
for mf in areas_layout.listElements("MAPFRAME_ELEMENT"):
    for l in mf.map.listLayers():
        if l.name in [
            "OCTraffic Cities Summary",
            "OCTraffic Census Blocks Summary",
            "OCTraffic Boundaries",
            "Light Gray Base",
        ]:
            l.visible = True
...
for i in areas_lg1_cim.items:
    if i.name == "OCTraffic Cities Summary":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
for i in areas_lg2_cim.items:
    if i.name == "OCTraffic Census Blocks Summary":
        i.isVisible = True
        i.showLayerName = False
        i.autoVisibility = True
        i.keepTogetherOption = "Items"
...
graphics_list = octr.graphics_entry(
    ...
    gr_attr = {
        ...
        "name": "OCTraffic Areas Layout",
        "description": "Map layout for the OCTraffic project, visualizing areas data.",
        "caption": "Summary collision incident distribution of the OCTraffic geocoded crashes, by city area membership (left subgraph), and by membership in relevant US Census 2020 block area).",
        "type": "GIS Layout",
        "method": "geoprocessing",
        "file_format": ".png",
        "file": "Areas Layout",
