...
print("\nOC SWITRS Data Processing - Part 4 - Collision Data Analysis\n")
...
prj_meta = ocs.project_metadata(part=4, version=2025.2, silent=False)
...
latex_vars_tex_path = os.path.join(prj_dirs["analysis_graphics"], "latex_vars.tex")
...
# Function to plot a histogram of victim counts
def plot_victim_count_histogram(df, fig=None, ax=None):
    """
...
fig1, ax1 = plot_victim_count_histogram(crashes, fig=fig1, ax=ax1)
fig1.show()
plt.close(fig1)
...
def plot_collision_type_bar(df, fig=None, ax=None):
    """
...
fig2, ax2 = plot_collision_type_bar(crashes, fig=fig2, ax=ax2)
fig2.show()
plt.close(fig2)
...
def plot_fatalities_by_type_and_year(df, fig=None, ax=None):
...
fig3, ax3 = plot_fatalities_by_type_and_year(ts_year["crashes"], fig=fig3, ax=ax3)
fig3.show()
plt.close(fig3)
...
graphics_list = ocs.graphics_entry(
    ...
    gr_attr={
        ...
        "description": "Key accident statistics for the summary variables in the OCSWITRS datasets",
        "caption": (
...
# Function to compute monthly statistics (will be used also in the next section)
def compute_monthly_stats(ts_month: pd.DataFrame) -> pd.DataFrame:
    """
...
stats_month = compute_monthly_stats(ts_month["collisions"])
...
graphics_list = ocs.graphics_entry(
    ...
    gr_attr={
        ...
        "description": "Key statistics for the average and median variable values in the OCSWITRS datasets",
        "caption": (
...
graphics_list = ocs.graphics_entry(
    ...
    gr_attr={
        ...
        "description": "Key statistics for the collision incidents by year in the OCSWITRS datasets",
