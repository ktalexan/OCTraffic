...
print("\nOC SWITRS GIS Data Processing - Part 6 - GIS Feature Processing\n")
...
prj_meta = ocs.project_metadata(part = 6, version = 2025.2, silent = False)
...
collisions_alias = "OCSWITRS Collisions"
...
crashes_alias = "OCSWITRS Crashes"
...
parties_alias = "OCSWITRS Parties"
...
victims_alias = "OCSWITRS Victims"
...
blocks_alias = "OCSWITRS Census Blocks"
# Census Blocks feature class
...
boundaries_alias = "OCSWITRS Boundaries"
# Boundaries feature class
...
roads_major_alias = "OCSWITRS Major Roads"
...
roads_major_buffers_alias = "OCSWITRS Major Roads Buffers"
...
roads_major_buffers_sum_alias = "OCSWITRS Major Roads Buffers Summary"
...
roads_major_points_along_lines_alias = "OCSWITRS Major Roads Points Along Lines"
...
roads_major_split_alias = "OCSWITRS Major Roads Split"
...
roads_major_split_buffer_alias = "OCSWITRS Major Roads Split Buffer"
...
roads_major_split_buffer_sum_alias = "OCSWITRS Major Roads Split Buffer Summary"
...
blocks_sum_alias = "OCSWITRS Census Blocks Summary"
...
cities_sum_alias = "OCSWITRS Cities Summary"
...
crashes_500ft_from_major_roads_alias = "OCSWITRS Crashes 500 Feet from Major Roads"
...
crashes_hotspots_alias = "OCSWITRS Crashes Hot Spots"
...
crashes_optimized_hotspots_alias = "OCSWITRS Crashes Optimized Hot Spots"
...
crashes_find_hotspots_100m1km_alias = "OCSWITRS Crashes Find Hot Spots 100m 1km"
...
# Define the crashes find hot spots layer alias and modify the feature class alias
crashes_find_hotspots_150m2km_alias = "OCSWITRS Crashes Find Hot Spots 150m 2km"
...
# Define the crashes find hot spots layer alias and modify the feature class alias
crashes_find_hotspots_100m5km_alias = "OCSWITRS Crashes Find Hot Spots 100m 5km"
...
mdo_gdb = md.Metadata()
mdo_gdb.title = "AGPSWITRS Historical Traffic Collisions"
mdo_gdb.tags = "Orange County, California, OCSWITRS, Traffic, Traffic Conditions, Crashes, Collisions, Parties, Victims, Injuries, Fatalities, Hot Spots, Road Safety, Accidents, SWITRS, Transportation"
...
mdo_analysis.title = "OCSWITRS Traffic Collisions Analysis Dataset"
mdo_analysis.tags = "Orange County, California, OCSWITRS, Traffic, Traffic Conditions, Crashes, Collisions, Parties, Victims, Injuries, Fatalities, Hot Spots, Road Safety, Accidents, SWITRS, Transportation"
...
mdo_hotspots.title = "OCSWITRS Traffic Collisions Hotspots Dataset"
mdo_hotspots.tags = "Orange County, California, OCSWITRS, Traffic, Traffic Conditions, Crashes, Collisions, Parties, Victims, Injuries, Fatalities, Hot Spots, Road Safety, Accidents, SWITRS, Transportation"
...
mdo_raw = md.Metadata()
mdo_raw.title = "OCSWITRS Traffic Collisions Raw Data Dataset"
mdo_raw.tags = "Orange County, California, OCSWITRS, Traffic, Traffic Conditions, Crashes, Collisions, Parties, Victims, Injuries, Fatalities, Hot Spots, Road Safety, Accidents, SWITRS, Transportation"
...
mdo_supporting.title = "OCSWITRS Traffic Collisions Supporting Data Dataset"
mdo_supporting.tags = "Orange County, California, OCSWITRS, Traffic, Traffic Conditions, Crashes, Collisions, Parties, Victims, Injuries, Fatalities, Hot Spots, Road Safety, Accidents, SWITRS, Transportation"
...
mdo_blocks.title = "OCSWITRS US Census 2020 Blocks"
