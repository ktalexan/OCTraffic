...
print("\nOC SWITRS GIS Data Processing - Part 7 - GIS Map Processing\n")
...
prj_meta = ocs.project_metadata(part=7, version=2025.2, silent=False)
        ...
        case "layer":
            ...
            for m in aprx.listMaps():
                for l in m.listLayers():
                    if l == cim_object:
                        cim_new_name = m.name.title() + "Map-" + l.name.replace("OCSWITRS ", "")
...
mdo_map_collisions.title = "OCSWITRS Collisions Map"
mdo_map_collisions.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transporation"
...
mdo_map_crashes.title = "OCSWITRS Crashes Map"
mdo_map_crashes.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_parties.title = "OCSWITRS Parties Map"
mdo_map_parties.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Parties, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_victims.title = "OCSWITRS Victims Map"
mdo_map_victims.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Victims, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_injuries.title = "OCSWITRS Injuries Map"
mdo_map_injuries.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Injuries, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_fatalities.title = "OCSWITRS Fatalities Map"
mdo_map_fatalities.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transporation"
...
mdo_map_fhs_100m1km.title = "OCSWITRS Hot Spot Analysis 100m 1km Map"
mdo_map_fhs_100m1km.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_fhs_100m1km.description = """<div style = "text-align:Left;"><div><div><p><span>Hot Spot Analysis for the OCSWITRS Project Data using 100m bins and 1km neighborhood radius grid</span></p></div></div></div>"""
...
mdo_map_fhs_150m2km.title = "OCSWITRS Hot Spot Analysis 150m 2km Map"
mdo_map_fhs_150m2km.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_fhs_150m2km.description = """<div style = "text-align:Left;"><div><div><p><span>Hot Spot Analysis for the OCSWITRS Project Data using 150m bins and 2km neighborhood radius grid</span></p></div></div></div>"""
...
mdo_map_fhs_100m5km.title = "OCSWITRS Hot Spot Analysis 100m 5km Map"
mdo_map_fhs_100m5km.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_fhs_100m5km.description = """<div style = "text-align:Left;"><div><div><p><span>Hot Spot Analysis for the OCSWITRS Project Data using 100m bins and 5km neighborhood radius grid</span></p></div></div></div>"""
...
mdo_map_fhs_roads_500ft.title = "OCSWITRS Hot Spots within 500ft from Major Roads Map"
mdo_map_fhs_roads_500ft.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_fhs_roads_500ft.description = """<div style = "text-align:Left;"><div><div><p><span>Hot Spot Analysis for the OCSWITRS Project Data within 500ft from Major Roads</span></p></div></div></div>"""
...
mdo_map_ohs_roads_500ft.title = "OCSWITRS Optimized Hot Spots within 500ft from Major Roads Map"
mdo_map_ohs_roads_500ft.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_ohs_roads_500ft.description = """<div style = "text-align:Left;"><div><div><p><span>Optimized Hot Spot Analysis for the OCSWITRS Project Data within 500ft from Major Roads</span></p></div></div></div>"""
...
mdo_map_road_crashes.title = "OCSWITRS Major Road Crashes Map"
mdo_map_road_crashes.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_road_hotspots.title = "OCSWITRS Major Road Hotspots Map"
mdo_map_road_hotspots.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_road_buffers.title = "OCSWITRS Major Road Buffers Map"
mdo_map_road_buffers.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_roads.title = "OCSWITRS Roads Processing Map"
mdo_map_roads.tags = "Orange County, California, Roads, Traffic, Road Safety, Transportation, Collisions, Crashes, SWITRS, OCSWITRS"
mdo_map_roads.summary = "Roads Processing Map for the OCSWITRS Project"
...
mdo_map_point_fhs.title = "OCSWITRS Point Features Hot Spots Map"
mdo_map_point_fhs.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_point_fhs.description = """<div style = "text-align:Left;"><div><div><p><span>Hot Spot Analysis for the OCSWITRS Project Data using point features</span></p></div></div></div>"""
...
mdo_map_point_ohs.title = "OCSWITRS Point Features Optimized Hot Spots Map"
mdo_map_point_ohs.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_point_ohs.description = """<div style = "text-align:Left;"><div><div><p><span>Optimized Hot Spot Analysis for the OCSWITRS Project Data using point features</span></p></div></div></div>"""
...
mdo_map_pop_dens.title = "OCSWITRS Population Density Map"
mdo_map_pop_dens.tags = "Orange County, California, Roads, Traffic, Road Safety, Transportation, Collisions, Crashes, SWITRS, OCSWITRS"
mdo_map_pop_dens.summary = "Population Density Map for the OCSWITRS Project"
...
mdo_map_hou_dens.title = "OCSWITRS Housing Density Map"
mdo_map_hou_dens.tags = "Orange County, California, Roads, Traffic, Road Safety, Transportation, Collisions, Crashes, SWITRS, OCSWITRS"
mdo_map_hou_dens.summary = "Housing Density Map for the OCSWITRS Project"
...
mdo_map_area_cities.title = "OCSWITRS City Areas Victims Count Map"
mdo_map_area_cities.tags = "Orange County, California, Roads, Traffic, Road Safety, Transportation, Collisions, Crashes, SWITRS, OCSWITRS"
mdo_map_area_cities.summary = "City Areas Victims Count Map for the OCSWITRS Project"
...
mdo_map_area_blocks.title = "OCSWITRS Census Blocks Victims Count Map"
mdo_map_area_blocks.tags = "Orange County, California, Roads, Traffic, Road Safety, Transportation, Collisions, Crashes, SWITRS, OCSWITRS"
mdo_map_area_blocks.summary = "Census Blocks Victims Count Map for the OCSWITRS Project"
...
mdo_map_summaries.title = "OCSWITRS Summaries Map"
mdo_map_summaries.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_summaries.description = """<div style = "text-align:Left;"><div><div><p><span>Summarized data representation and visualization for the Orange County OCSWITRS traffic incident data.</span></p></div></div></div>"""
...
mdo_map_analysis.title = "OCSWITRS Analysis Map"
mdo_map_analysis.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_analysis.description = """<div style = "text-align:Left;"><div><div><p><span>Analysis and visualization for the OCSWITRS Project Data</span></p></div></div></div>"""
...
mdo_map_regression.title = "OCSWITRS Regression Analysis Map"
mdo_map_regression.tags = "Orange County, California, Traffic, Traffic Conditions, Crashes, Collisions, Road Safety, Accidents, SWITRS, OCSWITRS, Transportation"
...
mdo_map_regression.description = """<div style = "text-align:Left;"><div><div><p><span>Regression Analysis for the OCSWITRS Project Data</span></p></div></div></div>"""
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Collisions.lyrx"),
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Roads.lyrx"),
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Census Blocks.lyrx"),
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Cities.lyrx"),
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Boundaries.lyrx"),
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Crashes.lyrx"),
    symbology_fields = [["VALUE_FIELD", "coll_severity", "coll_severity"]],
    update_symbology = "MAINTAIN",
)
print(arcpy.GetMessages())
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Parties.lyrx"),
    symbology_fields = [["VALUE_FIELD", "coll_severity", "coll_severity"]],
    update_symbology = "MAINTAIN",
)
print(arcpy.GetMessages())
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Victims.lyrx"),
    symbology_fields = [["VALUE_FIELD", "coll_severity", "coll_severity"]],
    update_symbology = "MAINTAIN",
)
print(arcpy.GetMessages())
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Crashes Killed Victims.lyrx"),
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Major Roads Buffers.lyrx"),
    symbology_fields = None,
    update_symbology = "MAINTAIN",
)
print(arcpy.GetMessages())
...
map_fhs_150m2km.moveLayer(
    reference_layer=map_fhs_150m2km_lyr_boundaries, move_layer=map_fhs_150m2km_lyr_roads, insert_position="AFTER"
)
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Major Roads.lyrx"),
    symbology_fields = [["VALUE_FIELD", "road_cat", "road_cat"]],
    update_symbology = "MAINTAIN",
)
print(arcpy.GetMessages())
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Major Roads Buffers Summary.lyrx"),
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Major Roads Split Buffer Summary.lyrx"),
...
# Rename the layer
map_pop_dens_lyr_pop_dens.name = "OCSWITRS Population Density"
# Set layer visibility on the map
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Population Density.lyrx"),
    symbology_fields = [["VALUE_FIELD", "population_density", "population_density"]],
    update_symbology = "MAINTAIN",
)
print(arcpy.GetMessages())
...
# Rename the layer
map_hou_dens_lyr_hou_dens.name = "OCSWITRS Housing Density"
# Set layer visibility on the map
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Housing Density.lyrx"),
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Cities Summary.lyrx"),
    symbology_fields = [["VALUE_FIELD", "sum_victim_count", "sum_victim_count"]],
    update_symbology = "MAINTAIN",
)
...
arcpy.management.ApplySymbologyFromLayer(
    ...
    in_symbology_layer = os.path.join(prj_dirs.get("layers_templates", ""), "OCSWITRS Census Blocks Summary.lyrx"),
    symbology_fields = [["VALUE_FIELD", "sum_victim_count", "sum_victim_count"]],
