...
print("\nOC SWITRS GIS Data Processing - Part 9 - Sharing ArcGIS Data Online\n")
...
prj_meta = ocs.project_metadata(part = 9, version = 2025.2, silent = False)
...
lyr_collisions = map_collisions.listLayers("OCSWITRS Collisions")[0]
lyr_roads = map_collisions.listLayers("OCSWITRS Roads")[0]
lyr_blocks = map_collisions.listLayers("OCSWITRS Census Blocks")[0]
lyr_cities = map_collisions.listLayers("OCSWITRS Cities")[0]
lyr_boundaries = map_collisions.listLayers("OCSWITRS Boundaries")[0]
...
lyr_crashes = map_crashes.listLayers("OCSWITRS Crashes")[0]
...
lyr_parties = map_parties.listLayers("OCSWITRS Parties")[0]
...
lyr_victims = map_victims.listLayers("OCSWITRS Victims")[0]
...
cities_service_name = "OCSWITRS Cities"
...
roads_service_name = "OCSWITRS Roads"
...
blocks_service_name = "OCSWITRS Census Blocks"
...
crashes_service_name = "OCSWITRS Crashes"
...
parties_service_name = "OCSWITRS Parties"
...
victims_service_name = "OCSWITRS Victims"
...
collisions_service_name = "OCSWITRS Collisions"
