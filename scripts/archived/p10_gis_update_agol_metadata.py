...
print("\nOC SWITRS GIS Data Processing - Part 10 - Updating ArcGIS Online Metadata\n")
...
import os, json, pytz, arcpy, arcgis
...
prj_meta = ocs.project_metadata(part=10, version=2025.2, silent=False)
...
agol_list = {
    "Web maps": [
        "OCSWITRS Victims Map",
        "OCSWITRS Parties Map",
        "OCSWITRS Crashes Map",
        "OCSWITRS Collisions App Map",
        "OCSWITRS Historical Collisions Map"
    ],
    "Dashboards": [
        "OCSWITRS Crashes Dashboard",
        "OCSWITRS Collisions Dashboard"
    ],
    "Instant Apps": [
        "OC Traffic Collisions Slider"
    ]
}
...
md_parties_map["licenseInfo"] = f"""<p>The SWITRS data displayed are provided by the California Highway Patrol (CHP) reports through the Transportation Injury Mapping System (TIMS) of the University of California, Berkeley. Issues of report accuracy should be addressed to CHP.&nbsp;<br>The displayed mapped data can be used under a&nbsp;<a target="_blank" rel="noopener noreferrer" href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons CC-SA-BY</a>&nbsp;License, providing attribution to TIMS, CHP, and OC Public Works, OC Survey Geospatial Services.<br>We make every effort to provide the most accurate and up-to-date data and information. Nevertheless, the data feed is provided, 'as is' and OC Public Work's standard&nbsp;<a target="_blank" rel="noopener noreferrer" href="https://www.ocgov.com/contact-county/disclaimer">Disclaimer</a>&nbsp;applies.</p><p>&nbsp;For any inquiries, suggestions or questions, please contact:</p><p style="text-align:center;"><a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/ktalexan/"><strong>Dr. Kostas Alexandridis, GISP</strong></a><br>GIS Analyst | Spatial Complex Systems Scientist<br>OC Public Works/OC Survey Geospatial Applications<br>601 N. Ross Street, P.O. Box 4048, Santa Ana, CA 92701<br>Email:&nbsp;<a href="mailto:kostas.alexandridis@ocpw.ocgov.com">kostas.alexandridis@ocpw.ocgov.com</a>&nbsp;| Phone: (714) 967-0826</p>"""

# Define the tags metadata for the Parties Web Map
md_parties_map["tags"] = ["Orange County", "California", "OCSWITRS", "SWITRS", "Traffic", "Traffic Conditions", "Crashes", "Parties", "Vehicles", "Collisions", "Road Safety", "Accidents", "Transportation"]
...
md_crashes_map["licenseInfo"] = f"""<p>The SWITRS data displayed are provided by the California Highway Patrol (CHP) reports through the Transportation Injury Mapping System (TIMS) of the University of California, Berkeley. Issues of report accuracy should be addressed to CHP.&nbsp;<br>The displayed mapped data can be used under a&nbsp;<a target="_blank" rel="noopener noreferrer" href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons CC-SA-BY</a>&nbsp;License, providing attribution to TIMS, CHP, and OC Public Works, OC Survey Geospatial Services.<br>We make every effort to provide the most accurate and up-to-date data and information. Nevertheless, the data feed is provided, 'as is' and OC Public Work's standard&nbsp;<a target="_blank" rel="noopener noreferrer" href="https://www.ocgov.com/contact-county/disclaimer">Disclaimer</a>&nbsp;applies.</p><p>&nbsp;For any inquiries, suggestions or questions, please contact:</p><p style="text-align:center;"><a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/ktalexan/"><strong>Dr. Kostas Alexandridis, GISP</strong></a><br>GIS Analyst | Spatial Complex Systems Scientist<br>OC Public Works/OC Survey Geospatial Applications<br>601 N. Ross Street, P.O. Box 4048, Santa Ana, CA 92701<br>Email:&nbsp;<a href="mailto:kostas.alexandridis@ocpw.ocgov.com">kostas.alexandridis@ocpw.ocgov.com</a>&nbsp;| Phone: (714) 967-0826</p>"""

# Define the tags metadata for the Crashes Web Map
md_crashes_map["tags"] = ["Orange County", "California", "OCSWITRS", "SWITRS", "Traffic", "Traffic Conditions", "Crashes", "Collisions", "Road Safety", "Accidents", "Transportation"]
...
md_collisions_app_map["licenseInfo"] = f"""<p>The SWITRS data displayed are provided by the California Highway Patrol (CHP) reports through the Transportation Injury Mapping System (TIMS) of the University of California, Berkeley. Issues of report accuracy should be addressed to CHP.&nbsp;<br>The displayed mapped data can be used under a&nbsp;<a target="_blank" rel="noopener noreferrer" href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons CC-SA-BY</a>&nbsp;License, providing attribution to TIMS, CHP, and OC Public Works, OC Survey Geospatial Services.<br>We make every effort to provide the most accurate and up-to-date data and information. Nevertheless, the data feed is provided, 'as is' and OC Public Work's standard&nbsp;<a target="_blank" rel="noopener noreferrer" href="https://www.ocgov.com/contact-county/disclaimer">Disclaimer</a>&nbsp;applies.</p><p>&nbsp;For any inquiries, suggestions or questions, please contact:</p><p style="text-align:center;"><a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/ktalexan/"><strong>Dr. Kostas Alexandridis, GISP</strong></a><br>GIS Analyst | Spatial Complex Systems Scientist<br>OC Public Works/OC Survey Geospatial Applications<br>601 N. Ross Street, P.O. Box 4048, Santa Ana, CA 92701<br>Email:&nbsp;<a href="mailto:kostas.alexandridis@ocpw.ocgov.com">kostas.alexandridis@ocpw.ocgov.com</a>&nbsp;| Phone: (714) 967-0826</p>"""

# Define the tags metadata for the Collisions App Web Map
md_collisions_app_map["tags"] = ["Orange County", "California", "OCSWITRS", "SWITRS", "Traffic", "Traffic Conditions", "Crashes", "Collisions", "Road Safety", "Accidents", "Transportation"]
...
md_historical_collisions_map["tags"] = ["Orange County", "California", "OCSWITRS", "SWITRS", "Traffic", "Traffic Conditions", "Crashes", "Collisions", "Road Safety", "Accidents", "Transportation"]
...
md_crashes_dashboard["licenseInfo"] = f"""<p>The SWITRS data displayed are provided by the California Highway Patrol (CHP) reports through the Transportation Injury Mapping System (TIMS) of the University of California, Berkeley. Issues of report accuracy should be addressed to CHP.&nbsp;<br>The displayed mapped data can be used under a&nbsp;<a target="_blank" rel="noopener noreferrer" href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons CC-SA-BY</a>&nbsp;License, providing attribution to TIMS, CHP, and OC Public Works, OC Survey Geospatial Services.<br>We make every effort to provide the most accurate and up-to-date data and information. Nevertheless, the data feed is provided, 'as is' and OC Public Work's standard&nbsp;<a target="_blank" rel="noopener noreferrer" href="https://www.ocgov.com/contact-county/disclaimer">Disclaimer</a>&nbsp;applies.</p><p>&nbsp;For any inquiries, suggestions or questions, please contact:</p><p style="text-align:center;"><a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/ktalexan/"><strong>Dr. Kostas Alexandridis, GISP</strong></a><br>GIS Analyst | Spatial Complex Systems Scientist<br>OC Public Works/OC Survey Geospatial Applications<br>601 N. Ross Street, P.O. Box 4048, Santa Ana, CA 92701<br>Email:&nbsp;<a href="mailto:kostas.alexandridis@ocpw.ocgov.com">kostas.alexandridis@ocpw.ocgov.com</a>&nbsp;| Phone: (714) 967-0826</p>"""

# Define the tags metadata for the Crashes Dashboard
md_crashes_dashboard["tags"] = ["Orange County", "California", "OCSWITRS", "SWITRS", "Traffic", "Traffic Conditions", "Crashes", "Collisions", "Road Safety", "Accidents", "Transportation", "Dashboard"]
...
md_collisions_dashboard["tags"] = ["Orange County", "California", "OCSWITRS", "SWITRS", "Traffic", "Traffic Conditions", "Crashes", "Collisions", "Road Safety", "Accidents", "Transportation", "Dashboard"]
...
md_oc_traffic_collision_slider_app["tags"] = ["Orange County", "California", "OCSWITRS", "SWITRS", "Traffic", "Traffic Conditions", "Crashes", "Collisions", "Road Safety", "Accidents", "Transportation", "Web Mapping Application", "Instant App"]
